  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "live-present": resolve(__dirname, "live-present.html"),
        "live-master": resolve(__dirname, "live-master.html"),
        "live-join": resolve(__dirname, "live-join.html"),
        "live-preview": resolve(__dirname, "live-preview.html"),
